export const CONFIG = {
  ...
  wordListSourceLink:
    'http://hesquiahtlanguage.org/uploads/6/8/7/0/6870919/taataaqsapa_1991_ocr.pdf', // Put a link to the source material for your words here
  //
  // THESE NEXT SETTINGS ARE FOR ADVANCED USERS
  //
  googleAnalytics: 'UA-219518570-2', // You can use this if you use Google Analytics
